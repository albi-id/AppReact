import { i as __toESM, n as __commonJS, t as require_react } from "./react-L5qjOZqY.js";
import { t as require_react_dom } from "./react-dom-Dqs8Ps0O.js";
		...
		if (r$20.dispose(), t$12.current === null) {
			t$12.current = s$19.currentTarget, l$17(!0);
			{
				...
				r$20.addEventListener(i$15, "pointerup", o$19, !1), r$20.addEventListener(i$15, "pointermove", (c$20) => {
					if (t$12.current) l$17(P$6(E$12(c$20), t$12.current.getBoundingClientRect()));
...
var Virtualizer = class {
	constructor(opts) {
		...
		this.resizeItem = (index$2, size$3) => {
			const item = this.measurementsCache[index$2];
			if (!item) return;
			const delta = size$3 - (this.itemSizeCache.get(item.key) ?? item.size);
			if (delta !== 0) {
		...
		this.getVirtualItems = memo(() => [this.getVirtualIndexes(), this.getMeasurements()], (indexes, measurements) => {
			...
			for (let k$13 = 0, len = indexes.length; k$13 < len; k$13++) {
				const measurement = measurements[indexes[k$13]];
	...
	return t$8() ? { before({ doc: o$19, d: r$20, meta: m$9 }) {
		...
		r$20.microTask(() => {
			...
			r$20.addEventListener(o$19, "click", (t$12) => {
				...
				var e$8;
				s$19 !== ((e$8 = window.scrollY) != null ? e$8 : window.pageYOffset) && window.scrollTo(0, s$19), l$17 && l$17.isConnected && (l$17.scrollIntoView({ block: "nearest" }), l$17 = null);
			});
		});
	} } : {};
}
...
function N$1(e$8, r$20, t$12, n$16) {
	let [i$15, a$27] = (0, import_react.useState)(t$12), { hasFlag: s$19, addFlag: o$19, removeFlag: l$17 } = c$13(e$8 && i$15 ? 3 : 0), u$24 = (0, import_react.useRef)(!1), f$21 = (0, import_react.useRef)(!1);
	return n$1(() => {
		var d$13;
		if (e$8) {
			if (t$12 && a$27(!0), !r$20) {
...
function Ao(T$9, O$4) {
	...
	k$1(S$1($$5, (0, import_react.useCallback)((i$15) => $$5.selectors.isTop(i$15, e$8), [$$5, e$8])), [
		Y$4,
		s$19,
		U$2
...
function Fe$5(e$8, t$12) {
	...
	let [, T$9] = N$1((() => !(!n$16 || !f$21 || !G$5 || ce$2))(), a$27, u$24, {
		start: Z$3,
		end: $$5
	}), Ce$4 = m({
		ref: U$2,
...
function Ie$3(e$8, t$12) {
	let { show: n$16, appear: l$17 = !1, unmount: S$9 = !0, ...R$6 } = e$8, d$13 = (0, import_react.useRef)(null), C$10 = y$1(...ue$2(e$8) ? [d$13, t$12] : t$12 === null ? [] : [t$12]);
	l$5();
	let p$12 = u$6();
...
function Ye(e$8, t$12) {
	let o$19 = (0, import_react.useId)(), { id: a$27 = `headlessui-dialog-panel-${o$19}`, transition: n$16 = !1, ...i$15 } = e$8, [{ dialogState: p$12, unmount: d$13 }, s$19] = O("Dialog.Panel"), f$21 = y$1(t$12, s$19.panelRef), u$24 = n({ open: p$12 === 0 }), S$9 = {
		ref: f$21,
		id: a$27,
		onClick: o((I$9) => {
			I$9.stopPropagation();
...
function Ae$3(e$8, t$12) {
	let l$17 = (0, import_react.useId)(), { id: p$12 = `headlessui-disclosure-button-${l$17}`, disabled: a$27 = !1, autoFocus: c$20 = !1, ...n$16 } = e$8, [o$19, r$20] = M$4("Disclosure.Button"), f$21 = ye$2(), s$19 = f$21 === null ? !1 : f$21 === o$19.panelId, T$9 = y$1((0, import_react.useRef)(null), t$12, o((i$15) => {
		if (!s$19) return r$20({
			type: 4,
			element: i$15
		});
...
function _t$1(b$13, E$13) {
	...
	f$3(I$9 ? !1 : _$10 && p$12 === F$1.Open, c$20);
	y$2(I$9 ? !1 : _$10 && p$12 === F$1.Open, { allowed: (0, import_react.useCallback)(() => [S$9, h$14], [S$9, h$14]) });
	let n$16 = S$1(t$12, t$12.selectors.didButtonMove) ? !1 : f$21, U$2 = u$10(S$1(t$12, t$12.selectors.hasFrozenValue) && !b$13.static, l$17.value), H$8 = (0, import_react.useCallback)((e$8) => l$17.compare(U$2, e$8), [l$17.compare, U$2]), A$4 = S$1(t$12, (e$8) => {
		var de$5;
	...
	})()), ne$3 = Te(), re$4 = y$1(E$13, o$19 ? r$20 : null, t$12.actions.setOptionsElement, O$4), q$4 = p();
	(0, import_react.useEffect)(() => {
		let e$8 = h$14;
...
function et(m$9, y$9) {
	let l$17 = (0, import_react.useId)(), { __demoMode: a$27 = !1, ...p$12 } = m$9, s$19 = s$8({
		...
		d$13.itemsElement,
		d$13.buttonElement
	]), _$10 = y$1(y$9), o$19 = x$3.get(null);
	k$1(S$1(o$19, (0, import_react.useCallback)((d$13) => o$19.selectors.isTop(d$13, l$17), [o$19, l$17])), [f$21, M$11], (d$13, T$9) => {
		var P$7;
...
function at(m$9, y$9) {
	...
	let H$8 = S$1(o$19, (e$8) => e$8.__demoMode);
	f$3(H$8 ? !1 : n$16 && T$9 === P.Open, O$4);
	y$2(H$8 ? !1 : n$16 && T$9 === P.Open, { allowed: (0, import_react.useCallback)(() => [P$7, i$15], [P$7, i$15]) });
		...
		function e$8() {
			u$2(H$8.current, {
				[a$2.Forwards]: () => {
					...
					let i$15 = x$2((Be$3 = r(o$19.state.button)) != null ? Be$3 : document.body), x$9 = i$15.indexOf(o$19.state.button), S$9 = i$15.slice(0, x$9 + 1), se$2 = [...i$15.slice(x$9 + 1), ...S$9];
...
function Le$2(n$16, t$12) {
	var g$8;
	let a$27 = (0, import_react.useId)(), f$21 = u$1(), h$14 = a(), { id: b$13 = f$21 || `headlessui-switch-${a$27}`, disabled: o$19 = h$14 || !1, checked: s$19, defaultChecked: T$9, onChange: y$9, name: p$12, value: c$20, form: u$24, autoFocus: S$9 = !1, ...C$10 } = n$16, _$10 = (0, import_react.useContext)(E$1), [L$6, R$6] = (0, import_react.useState)(null), A$4 = y$1((0, import_react.useRef)(null), t$12, _$10 === null ? null : _$10.setSwitch, R$6), l$17 = l(T$9), [d$13, r$20] = b$2(s$19, y$9, l$17 != null ? l$17 : !1), F$6 = p(), [H$8, P$7] = (0, import_react.useState)(!1), D$11 = o(() => {
